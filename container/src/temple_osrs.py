...
bosses = ["Abyssal Sire","Alchemical Hydra","Barrows Chests","Bryophyta","Callisto","Cerberus","Chambers of Xeric","Chambers of Xeric Challenge Mode","Chaos Elemental","Chaos Fanatic","Commander Zilyana","Corporeal Beast","Crazy Archaeologist","Dagannoth Prime","Dagannoth Rex","Dagannoth Supreme","Deranged Archaeologist","General Graardor","Giant Mole","Grotesque Guardians","Hespori","Kalphite Queen","King Black Dragon","Kraken","KreeArra","Kril Tsutsaroth","Mimic", "Obor","Sarachnis","Scorpia","Skotizo","The Gauntlet","The Corrupted Gauntlet","Theatre of Blood","Thermonuclear Smoke Devil","TzKal-Zuk","TzTok-Jad","Venenatis","Vetion","Vorkath","Wintertodt","Zalcano","Zulrah","The Nightmare","Tempoross","Theatre of Blood Challenge Mode","Phosanis Nightmare","Nex","Rift","Tombs of Amascut","Tombs of Amascut Expert","Phantom Muspah", "Artio", "Calvarion", "Spindel", "Duke Sucellus", "The Whisperer", "Vardorvis", "The Leviathan", "Scurrius", "Lunar Chests", "Sol Heredit"] # removed , "Colosseum Glory"
...
class TempleOsrs():
    ...
    async def cheat(self):
        t = time.time()
        resp = await self.__call_api("https://templeosrs.com/api/player_stats.php", {'player':"Fiz X", 'bosses':'1','date':t})
        print(resp.text)
        print("-------------------------")
